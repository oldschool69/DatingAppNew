...
export class MessageService {
  ...
  createHubConnection(otherUserId: string) {
    ...
    console.log('***DEBUG Starting connection to hub ');
    console.log('***DEBUG hub url: ' + this.hubUrl + 'messages?userId=' + otherUserId);
    ...
    this.hubConnection.start().catch(error => console.log('***DEBUG Error establishing connection: ', error));

    this.hubConnection.on('ReceiveMessageThread', (messages: Message[]) => {
      console.log('***DEBUG ReceiveMessageThread', messages);
